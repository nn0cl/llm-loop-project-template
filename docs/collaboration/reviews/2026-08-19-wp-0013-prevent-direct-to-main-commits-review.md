...
- Specification: none — documentation/process-only change, per
  `DA-2026-08-19-01`'s "Specifications" section
...
- Reviewing persona / model / tool: Reviewer, Claude Sonnet 5 via Claude
  ...
  that wrote `DA-2026-08-19-01` and the Implementation session that made
  the edits
...
- Whether a git hook or CI check should enforce this rule — explicitly out
  of scope per `DA-2026-08-19-01` and recorded as a Deferred Question there,
...
- [x] Every `Then` clause in the specification is asserted by the work — not
      ...
      per `DA-2026-08-19-01`'s own "Specifications" section.
...
- All four of `DA-2026-08-19-01`'s explicit Falsification Criteria were
...
- Scope matches `DA-2026-08-19-01` exactly: 6 files, all named in the
...
- `local-issue-planning.md`'s broadened "Dependency Rules" sentence
  ...
  `DA-2026-08-19-01` states the intent was to avoid "duplicating the rule's
