...
- `docs/architecture/adr/0001-*.md` through `0017-*.md` are the process ADRs
  this template ships with; remove only those seventeen, and keep any ADR your
  project numbered afterward (0018 and up).
...
- `.github/workflows/ci.yml` — edit this **first**. Its "Check required
  ...
  records" asserts ADRs 0001–0017. Deleting anything before trimming those
