...
- `docs/architecture/adr/0001-*.md` through `0014-*.md` are the process ADRs
  this template ships with; remove only those fourteen, and keep any ADR your
  project numbered afterward (0015 and up).
...
- `.github/workflows/ci.yml` — edit this **first**. Its "Check required
  ...
  records" asserts ADRs 0001–0014. Deleting anything before trimming those
